...
<main>
        ...
        <div class="container">
            <div class="dragon-block">
                <div class="dragon-block__item">
                    <img class="dragon-logo" src="<?=SITE_TEMPLATE_PATH?>/img/dragon-logo.png" alt="" />
                ...
                <div class="dragon-block__item dragon-block__item-angelina">
                    <img class="angelina-bg" src="<?=SITE_TEMPLATE_PATH?>/img/angelina-bg-mob.png" alt="" />
        ...
        <div class="container">
            <div class="count-content">
                <div class="count-item">
                    <h3>50+</h3>
                    <p>НИШ, в которых мы эксперты</p>
                </div>
                <div class="count-item">
                    <h3>2+</h3>
                    <p>МЛРД, управление рекламным бюджетом</p>
                </div>
                <div class="count-item">
                    <h3>100+</h3>
                    <p>МЛРД, заработали клиенты</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="swiper agencySlider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="agency_wrap">
                            <div class="agencySlider-card">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/agency1.png" alt="" class="agencySlider-card-img" />
                    ...
                    <div class="swiper-slide">
                        <div class="agency_wrap">
                            <div class="agencySlider-card">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/agency2.png" alt="" class="agencySlider-card-img" />
                                <div class="agencySlider-text">
                                    <div class="agencySlider-titles">
                                        <h2>Мухаметдиннова Виссариона Константиновна</h2>
                                        <p>Резидент аналитического направления</p>
                                    </div>
                                    <button class="agency_card-btn">
                                        регалии
                                        <svg width="15" height="7" viewBox="0 0 15 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="agency_wrap">
                            <div class="agencySlider-card">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/agency3.png" alt="" class="agencySlider-card-img" />
                                <div class="agencySlider-text">
                                    <div class="agencySlider-titles">
                                        <h2>Иванов Иван Иванович</h2>
                                        <p>Резидент бренд коммуникации</p>
                                    </div>
                                    <button class="agency_card-btn">
                                        регалии
                                        <svg width="15" height="7" viewBox="0 0 15 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="agency_wrap">
                            <div class="agencySlider-card">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/agency4.png" alt="" class="agencySlider-card-img" />
                                <div class="agencySlider-text">
                                    <div class="agencySlider-titles">
                                        <h2>Петрова Ольга Васильевна</h2>
                                        <p>Резидент Digital направления</p>
                                    </div>
                                    <button class="agency_card-btn">
                                        регалии
                                        <svg width="15" height="7" viewBox="0 0 15 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="innovative_block">
                <div class="innovative_top">
                    ...
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/innovative-logo.svg" alt="" />
                </div>
                <div class="title">
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    ...
                                    <p>Наша компания прошла IT аккредитация что дает нам право заявлять о своей экспертности и гарантии для вас работы с нами</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    <h4>9 резидентов</h4>
                                    <p>Экперты с глубоким знаниям в области маркетинга и рекламы занимающие ТОП позиции в крупных компаниях со стажем 5+ лет</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    ...
                                    <p>Собственная запатентированная технология позволяющая реализовать 100% точную маркетинговую стратегию и запустить рекламу</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    <h4>BIG DATA</h4>
                                    <p>Собственный запатентированный сервис позволяющий получить статистические данные из достоверных источников и обработать с целью 100% картины рынка</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    ...
                                    <p>Мы за цифры, а не процессы поэтому вы видите результаты в цифровом эквиваленте которые демонстрируются на дашборде</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="item_info">
                                    <h4>AI зрение</h4>
                                    <p>Сервис позволяющий оценить ваш продукт перед выпуском на рынок и получить достоверную обратную связь от респондентов</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
        ...
        <div class="container">
            <div class="audience_block">
                <div class="title">
                    ...
                    <p>Рекламная коммуникация через воздействие на сознание</p>
                </div>
            ...
            <div class="marketing_slider marketing_slider2">
                <div class="swiper marketingSlider2">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img1.png" alt="" class="item_img" />
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img-mob1.png" alt="" class="item_img-mob" />
                                <div class="item_top">
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img2.png" alt="" class="item_img" />
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img-mob2.png" alt="" class="item_img-mob" />
                                <div class="item_top">
                                    <h3>Как повысить конверсии на сайте без бюджета</h3>
                                    <p>Партизанский маркетинг в Девелоперской компании</p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img3.png" alt="" class="item_img" />
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/marketing2-img-mob3.png" alt="" class="item_img-mob" />
                                <div class="item_top">
                                    <h3>Как повысить конверсии на сайте без бюджета</h3>
                                    <p>Партизанский маркетинг в Девелоперской компании</p>
                                </div>
            ...
            <div class="count-content">
                <div class="swiper partnerSlider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo1.svg" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo2.svg" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo3.png" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo4.png" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo7.svg" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo5.svg" alt="" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="count-item count_item-end">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/partner-logo6.svg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="available available2">
        <img src="<?=SITE_TEMPLATE_PATH?>/img/avi2_bg2.png" alt="" class="avi_bg-mob" />
        <img src="<?=SITE_TEMPLATE_PATH?>/img/avi2_bg3.png" alt="" class="avi_bg-mob2" />
        <div class="container">
            <div class="available_block">
                ...
                <div class="item_all no-scrollbar">
                    <div class="item">
                        ...
                        <a href="#">читать <img src="<?=SITE_TEMPLATE_PATH?>/img/Vector1.svg" alt="" /></a>
                    </div>
                    <div class="item">
        ...
        <div class="gradient_one">
            <img src="<?=SITE_TEMPLATE_PATH?>/img/gradient1.png" alt="" />
        </div>
    </div>
