...
/*ZDUyZmZZTIxYTgzM2U0NTY2YTkxODQyMjJiOTY4ZTgyZjBhYmM=*/$GLOBALS['____1708912625']= array(base64_decode('ZGV'.'m'.'aW5l'));if(!function_exists(__NAMESPACE__.'\\___1292777643')){function ___1292777643($_1504969234){static $_734381178= false; if($_734381178 == false) $_734381178=array('R'.'U'.'5DT'.'0R'.'F','WQ==');return base64_decode($_734381178[$_1504969234]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1336146972){ return true;} public static function IsFeatureEditable($_1336146972){ return true;} public static function SetFeatureEnabled($_1336146972, $_1531801454= true){} public static function SaveFeaturesSettings($_1172743155, $_2057985755){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_412308770){} public static function ModifyFeaturesSettings($_412308770, $_590503548){} public static function IsFeatureInstalled($_1336146972){ return true;}} $GLOBALS['____1708912625'][0](___1292777643(0), ___1292777643(1));/**/			//Do not remove this
